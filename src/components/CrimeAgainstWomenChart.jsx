...
const CrimeAgainstWomenChart = ({ compact = false }) => {
  const svgRef = useRef();
  ...
  useEffect(() => {
    ...
    g.selectAll(".bar")
      ...
      .on("mouseover", function (event, d) {
        ...
        tooltip
          .html(`<strong>${d.state}</strong><br/>Rate: ${d.rate}`)
    ...
    if (!compact) {
      svg
        ...
        .text("Crimes Against Women by State (2022)");
    }
...
export default CrimeAgainstWomenChart;
